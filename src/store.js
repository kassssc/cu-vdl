    ...
    submission: {
      ...
      tests: [
        ...
        },
        {
          ...
          reportType: 2,
          testInfo: [
            { id: 65, name: 'CSFV (SK6)',            cellId: 1, price: 3000 },
            { id: 66, name: 'ADV (SK6)',             cellId: 1, price: 3000 },
            { id: 67, name: 'PRRSV (US) (MARC145)',  cellId: 2, price: 3000 },
            { id: 68, name: 'PRRSV (EU) (MARC145)',  cellId: 2, price: 3000 },
            { id: 69, name: 'HP-PRRSV (MARC145)',    cellId: 2, price: 3000 },
            { id: 70, name: 'SIV (H1N1) (MDCK)',     cellId: 3, price: 3000 },
            { id: 71, name: 'H5N1 (EGG)',            cellId: 4, price: 3000 },
            { id: 72, name: 'NDV (EGG)',             cellId: 4, price: 3000 },
            { id: 73, name: 'PCV2 (PK15)',           cellId: 6, price: 3000 },
          ]
        },
        {
          id: 6,
