...
export default {
  name: 'sample-info',
  components: {
    'FormDisinfectantTestInput': FormDisinfectantTestInput,
    'FormAntibioticsSensitivity': FormAntibioticsSensitivity,
    'FormSampleInfoMultifill': FormSampleInfoMultifill,
